...
import 'package:flutter_asos_app/constant.dart';
...
Row _cartPriceDescriptionRightToImg(Product product) {
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceBetween,
    children: [
      Text("${product.price.currency} ${product.price.current.value}",
          style: mediumText),
      Row(
...
Row _viewTotalPrice(Product product) {
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceBetween,
    children: [
      Text(
